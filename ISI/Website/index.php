  ...
  while($row = $result->fetch_assoc()) {
    ...
    echo '<div class="col-md-4">
		<figure class="card card-product-grid">
			...
			echo '<a class="btn-overlay" href="product.php?p_id='.$row["p_id"].'"><i class="fa fa-search-plus"></i> Quick view</a>
			</div> <!-- img-wrap.// -->
			<figcaption class="info-wrap">
				<div class="fix-height">
					<a href="product.php?p_id='.$row["p_id"].'" class="title">'.$row["pname"].'</a>
				...
				<a href="product.php?p_id='.$row["p_id"].'" class="btn btn-block btn-primary">Add to cart</a>	
			</figcaption>
		</figure>
	</div> <!-- col.// -->';
...
<?php 
      $p_page =$page-1;
     echo '<li class="page-item"><a class="page-link" href = "index.php?page=' . $p_page . '&sort='.$sort.'&brand='.$brand.'&category='.$category.'&searching='.$searching.' "><</a></li>';
    for($page1 = 1; $page1<= $number_of_page; $page1++) {  
        if($page == $page1){ echo '<li class="page-item"><a class="page-link" style="background-color:Lightgray;" href = "index.php?page=' . $page1 . '&sort='.$sort.'&brand='.$brand.'&category='.$category.'&searching='.$searching.' ">' . $page1 . ' </a></li>';}
        else { echo '<li class="page-item"><a class="page-link" href = "index.php?page=' . $page1 . '&sort='.$sort.'&brand='.$brand.'&category='.$category.'&searching='.$searching.' ">' . $page1 . ' </a></li>';}
}   
    if($page<$number_of_page){
        $n_page =$page+1;
        echo '<li class="page-item"><a class="page-link" href = "index.php?page=' . $n_page . '&sort='.$sort.'&brand='.$brand.'&category='.$category.'&searching='.$searching.' "> ></a></li>';
    }
    else {
        echo '<li class="page-item"><a class="page-link" href = "index.php?page=' . $number_of_page . '&sort='.$sort.'&brand='.$brand.'&category='.$category.'&searching='.$searching.' ">> </a></li>';
    }
