...
//    echo $time;
        ...
        <div class="breadcrumb-outer pt-10">
            <div class="container">
                <div class="breadcrumb-content d-md-flex align-items-center pt-10">
                    <h2 class="mb-0">WEATCHER</h2>
                    <nav aria-label="breadcrumb">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Weathcer</li>
                        </ul>
                    </nav>
                </div>
            </div>
    ...
    <!-- cart -->
    <div id="cart-main" class="cart-main pt-10 pb-10">
                                ...
                                <table class="shop_table rt-checkout-review-order-table bg-white">
                                    <thead>
                                        <tr>
                                           ...
                                           <?php
                                            foreach ($time as $sub) {
                                              echo '<th class="product-name">'.$sub.'</th>';
                                            }
                                            ?>
                                    ...
                                    <tbody>
                                        <tr>
                                             <th>Image</th>
                                                                                       <?php
                                            foreach ($image as $sub) {
                                              echo '<td>';
                                              echo '<img src="img/'.$sub.'.png" alt="" class="w-25">';
                                              echo '</td>';
                                            }
                                            ?>
                                        ...
                                        <th>Temperature</th>
                                         <?php
                                            foreach ($weather as $sub) {
                                              echo '<th class="product-name">'.$sub.' °C</th>';
                                            }
                                            ?>
                                        </tr>
                                        <tr>
                                            ...
                                            else if($sub>2.5 && $sub<=5.5){
                                                $sub=$sub.'(Mid)';
                                            }
                                            else if($sub>5.5 && $sub<=7.5){
                                                $sub=$sub.'(High)';
                                            }
                                            else if($sub>7.5 && $sub<=10.5){
                                                $sub=$sub.'(Very High)';
                                            }
                                            else{
                                                $sub=$sub.'(Extreme)';
